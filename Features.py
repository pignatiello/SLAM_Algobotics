...
class featuresDetection: #modificato
    def __init__(self):
        #variables
        self.EPSILON = 10
        self.DELTA =  501
        ...
        self.LMIN = 20 # minimum lenght of a line segment
        self.LR = 0 # real lenght of a line segment
    ...
    def lineForm_Si2G(self, m, b):
        ...
        C = C * lcm
        return A, B, C
    # search intercept with two line
    def line_intersect_general(self, params1, params2):
        ...
        return x, y
    #equation line pass for two point
    def points_2line(self, point1, point2):
        m, b = 0, 0
        if point2[0] == point1[0]:
            pass 
        else:
            m = (point2[1] - point1[1]) / (point2[0] - point1[0]) #calcolate pendetion
            b = point2[1] - m * point2[0]
        return m, b
    #position ortogonal the point on line 
    ...
    #date lidar fornite with distanze and angle, the fx converter this date in x and y
    def ADZpos(self, distance, angle, robot_position):
    ...
    def laser_points_set(self, data):
        ...
        if not data:
            ...
            for point in data:
                coordinates = self.ADZpos(point[0], point[1], point[2])
    ...
    def odr_fit(self, laser_points):
        ...
        # Run the regression.# regressione lineare = trovare retta che meglio si adatta ai punti(fitta i dati) 
        out = odr_model.run()
        m, b = out.beta
        return m, b
    #preveredere la posiziome del pto   
    def predictPoint(self, line_params, sensed_point, robotpos):
        ...
        return predx, predy
    #SecondoGruppo #metodo rilevamento del segmento
        ...
        for i in range(break_point_ind, (self.NP - self.PMIN)):
            ...
            for k in range (i, j):
                ...
                if d1 > self.DELTA:
                    flag = False
                    break
                d2 = self.dist_point2line(params,self.LASERPOINTS[k][0]) #modificato
    ...
    def seed_segment_growing(self, indices, break_point):
        ...
        while self.dist_point2line(line_eq, self.LASERPOINTS[PB][0]):
            ...
            if self.dist_point2point(POINT, NEXTPOINT) > self.GMAX:
                break
        PB = PB + 1
        #LR = lunghezze segmento PR= numero segmenti che contiene la linea
